...
class AppThemeData {
  ...
  static const lightgrey = const Color.fromRGBO(247, 247, 247, 1.0);
  static const darkgrey = const Color.fromRGBO(247, 247, 247, 0.5);
  ...
  static TextTheme _textTheme = TextTheme(
    display1: _AppTextStyles.heading,
    caption: _AppTextStyles.studyTitle,
    headline: _AppTextStyles.categoryTitle,
    subhead: _AppTextStyles.listTitle,
    overline: _AppTextStyles.listDescription,
    body2: _AppTextStyles.sliderTitle,
    subtitle: _AppTextStyles.settingsFooter,
    body1: _AppTextStyles.options,
    title: _AppTextStyles.title,
  ...
  static BoxDecoration bottomBorder = new BoxDecoration(
    border: Border(
        bottom: BorderSide(
  ...
  static BoxDecoration defaultShadow =
      BoxDecoration(boxShadow: [BoxShadow(blurRadius: 5)]);
  static BoxDecoration defaultBorderAndShadow = BoxDecoration(
      border: Border.all(), boxShadow: [BoxShadow(blurRadius: 5)]);
}
